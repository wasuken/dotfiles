...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-jump-mode ace-window aggressive-indent apheleia auto-compile
                   ...
                   difftastic docker-compose-mode ef-themes
                   eglot-booster eglot-signature-eldoc-talkative
                   eglot-tempel eglot-x eldoc-box embark
                   embark-consult emmet-mode expreg flx
                   flymake-collection fontaine go-translate goggles
                   golden-ratio golden-ratio-mode highlight-defined
                   highlight-quoted imenu-list jsonrpc jtsx lin
                   macrostep magit marginalia markdown-mode migemo
                   minions modus-themes mozc nerd-icons-completion
                   nerd-icons-corfu nerd-icons-dired nyan-mode
                   orderless page-break-lines perfect-margin popon
                   prescient pulsar puni pyvenv rainbow-delimiters
                   reformatter restart-emacs rg rust-mode slime
                   slime-company spacious-padding sql-indent sqlformat
                   string-inflection tabnine tempel tempel-collection
                   tr-ime transient treesit treesit-auto treesitter
                   typescript-mode undo-fu undo-fu-session
                   vc-use-package vertico vertico-prescient
                   vertico-truncate vundo web-beautify wgrep which-key))
